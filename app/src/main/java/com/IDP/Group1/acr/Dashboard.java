...
public class Dashboard extends Fragment {
	...
	boolean isRecording,sweep_flag=true;
	ImageView alert,sleep,notification,mic,settings, battery, sweep_img, schdule_img, floor_img, filter_img, manual_img, analytics_img;
	TextView batteryText;
	Switch aSwitch;

	com.varunest.sparkbutton.SparkButton clean;
	pl.droidsonroids.gif.GifImageView sweep_gif;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		sweep_gif=V.findViewById(R.id.sweep_gif);
		sweep_img=V.findViewById(R.id.sweep_img);
		schdule_img=V.findViewById(R.id.schedule_img);
		floor_img=V.findViewById(R.id.floor_img);
		filter_img=V.findViewById(R.id.filter_img);
		manual_img=V.findViewById(R.id.manual_img);
		analytics_img=V.findViewById(R.id.analytics_img);

		sweep_gif.setVisibility(View.INVISIBLE);
...
//				dr.set(user);
		...
		sweep_img.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				sweep_img.setVisibility(View.INVISIBLE);
				sweep_gif.setVisibility(View.VISIBLE);
			}
		});
		sweep_gif.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				sweep_img.setVisibility(View.VISIBLE);
				sweep_gif.setVisibility(View.INVISIBLE);
			}
		});
		schdule_img.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				FragmentManager fragmentManager = getFragmentManager();
...
//				dr.set(user);
		...
		floor_img.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				FragmentManager fragmentManager = getFragmentManager();
...
//				dr.set(user);
		...
		analytics_img.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				FragmentManager fragmentManager = getFragmentManager();
